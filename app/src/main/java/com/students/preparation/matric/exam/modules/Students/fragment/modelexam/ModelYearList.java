package com.students.preparation.matric.exam.modules.Students.fragment.modelexam;
...
public class ModelYearList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listSubjectExamYear.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent exam = new Intent(getApplicationContext(), ModelActivity.class);
        ...
        if (extras != null) {
            ...
            DatabaseReference mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_MODEL_EXAM + "/" + subject);
